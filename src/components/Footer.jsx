...
function Footer() {
  return (
    <div className='flex flex-col items-center py-[10px] md:py-[48px] px-0 gap-[64px] bg-[#ffffff]'>
       <div className='flex flex-col items-center justify-center py-0 px-[32px] min-h-[64px]'>
          <div className='box-border flex flex-col md:flex-row justify-center items-center pt-[32px] px-0 pb-0 gap-[40px] md:gap-[60px] lg:gap-[32px] border-t border-[#EAECF0] border-solid'>
